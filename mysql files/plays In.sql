create table plays_in( pl_in_id int PRIMARY KEY, chm_id varchar(10)  NOT NULL , P_id int ,FOREIGN KEY  (chm_id ) REFERENCES championship(chm_Id), FOREIGN KEY (P_id) REFERENCES player(P_Id) );
